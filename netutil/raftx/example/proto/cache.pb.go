...
func (x *CacheMgr) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CacheMgr) ProtoMessage() {}

func (x *CacheMgr) ProtoReflect() protoreflect.Message {
	mi := &file_cache_proto_msgTypes[0]
...
// Deprecated: Use CacheMgr.ProtoReflect.Descriptor instead.
func (*CacheMgr) Descriptor() ([]byte, []int) {
	return file_cache_proto_rawDescGZIP(), []int{0}
}

func (x *CacheMgr) GetCache() map[string][]byte {
	if x != nil {
		return x.Cache
	}
	return nil
...
var file_cache_proto_rawDesc = []byte{
	,
...
var file_cache_proto_goTypes = []interface{}{
	(*CacheMgr)(nil), // 0: CacheMgr
	nil,              // 1: CacheMgr.CacheEntry
}
var file_cache_proto_depIdxs = []int32{
	1, // 0: CacheMgr.cache:type_name -> CacheMgr.CacheEntry
